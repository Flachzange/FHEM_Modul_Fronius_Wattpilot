...
- Regression im elektrischen Rate-Limit behoben: Nur eine Nachricht mit einem gültigen `nrg`-Array darf `LAST_UPDATE` fortschreiben. Batterie-, Konfigurations- oder ungültige `nrg`-Deltas verbrauchen das elektrische Intervall nicht mehr und können nachfolgende Spannungs-, Strom- und Leistungswerte daher nicht mehr verdrängen.

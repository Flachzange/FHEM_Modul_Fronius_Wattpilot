...
| `configLoadBalancingPriority` | Non-negative raw integer code from `lop`. Observed value `50` matched “Medium” in the app; values remain numeric because the full enum is not confirmed. |

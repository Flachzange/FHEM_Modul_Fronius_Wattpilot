...
| `load_balancing_phase_assignment` | `configLoadBalancingPhaseAssignment` | `configuration` | `status:map` | `immediate` | `none` | `map` | `phase_assignment` | `preserve` | Confirmed fixed vectors `[1,0,0]`, `[0,1,0]`, `[0,0,1]`, `[1,2,3]` render as `L1`, `L2`, `L3`, `L1 L2 L3`; all other vectors preserve the previous reading. |

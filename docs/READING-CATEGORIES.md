...
Version 2.1.8 retains the authoritative publication policy for every public
...
| `diag_temperature_sensor_3` | `diag_temperatureSensor3` | `optional_diagnostic` | `status:tma[2]` | `interval` | `diagnostic` | `diagnostic` | `decimal2` | `preserve` | Optional numeric temperature-array position 3; physical sensor location and unit are not claimed by this module. |
| `diag_temperature_sensor_4` | `diag_temperatureSensor4` | `optional_diagnostic` | `status:tma[3]` | `interval` | `diagnostic` | `diagnostic` | `decimal2` | `preserve` | Optional numeric temperature-array position 4; physical sensor location and unit are not claimed by this module. |
| `diag_temperature_sensor_5` | `diag_temperatureSensor5` | `optional_diagnostic` | `status:tma[4]` | `interval` | `diagnostic` | `diagnostic` | `decimal2` | `preserve` | Optional numeric temperature-array position 5; physical sensor location and unit are not claimed by this module. |
| `diag_temperature_sensor_6` | `diag_temperatureSensor6` | `optional_diagnostic` | `status:tma[5]` | `interval` | `diagnostic` | `diagnostic` | `decimal2` | `preserve` | Optional numeric temperature-array position 6; physical sensor location and unit are not claimed by this module. |

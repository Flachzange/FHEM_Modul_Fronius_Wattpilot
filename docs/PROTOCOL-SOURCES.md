...
- [`WATTPILOT-LEGACY-PROTOCOL2.md`](WATTPILOT-LEGACY-PROTOCOL2.md) defines the regression contract for the original Wattpilot generation. Version 1.5.0 preserves the evidenced PBKDF2 behavior when the legacy protocol-2 `authRequired` message omits `hash`.
